...
- After a save, git packs the memory's loose objects once many have piled up (`git gc --auto`, as after a commit of your own), so a memory never grows into thousands of loose files.
