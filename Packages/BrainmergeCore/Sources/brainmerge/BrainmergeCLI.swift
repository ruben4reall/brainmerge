...
struct BrainmergeCLI: ParsableCommand {
    static let configuration = CommandConfiguration(
        ...
        subcommands: [BrainCommand.self, AdoptPrimary.self, IdentityCommand.self, Sync.self, UsageCommand.self, DoctorCommand.self, InstallCLI.self, UninstallCommand.self]
    )
}
